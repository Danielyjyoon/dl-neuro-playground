...
base = r'C:\Users\byeby\Desktop\test\centiloid\Sev\2025\YC_add'
mask_path = r'C:\Users\byeby\Desktop\test\centiloid\Centiloid_Std_VOI\nifti\2mm'
...
for _, pid in tqdm(enumerate(pids), total=len(pids)):
    ...
    file_FBB = os.path.join(FILE_DIR, 'wFBB.nii')
...
# Save to Excel file
output_path = 'FBB_Klunk_YC_add.xlsx'
